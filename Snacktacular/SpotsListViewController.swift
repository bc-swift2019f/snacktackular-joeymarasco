...
class SpotsListViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        spots.spotArray.append(Spot(name: "Eagles", address: "Cleveland Circle", coordinate: CLLocationCoordinate2D(), averageRating: 0.0, numberOfReviews: 0, postingUserID: "", documentID: ""))
    }
