...
class SpotDetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if spot == nil {
            ...
            // hide toolbar so lookup place is not available
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        reviews.loadData(spot: spot) {
            ...
            if self.reviews.reviewArray.count > 0 {
                ...
                self.averageRatingLabel.text = "N/A"
            }
        }
    ...
    @IBAction func photoButtonPressed(_ sender: UIButton) {
        if spot.documentID == "" {
            saveCancelAlert(title: "This Venue Has Note Been Saved", message: "You must save this venue before you can add a photo.", segueIdentifier: "AddPhoto")
        } else {
    ...
    @IBAction func reviewButtonPressed(_ sender: UIButton) {
        if spot.documentID == "" {
            saveCancelAlert(title: "This Venue Has Note Been Saved", message: "You must save this venue before you can review it.", segueIdentifier: "AddReview")
        } else {
...
extension SpotDetailViewController: CLLocationManagerDelegate {
    ...
    func handleLocationAuthorizationStatus(status: CLAuthorizationStatus) {
        ...
        case .denied:
            showAlertToPrivacySettings(title: "User has not authorized location services", message: "Select 'Settings' below to open device settings and enable location services for the application. ")
        case .restricted:
            showAlert(title: "Location Services Denied", message: "Parental or corporate controls may be in place.")
        default:
            print("ERROR")
        }
    }
